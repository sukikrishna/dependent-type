...
def type_check(env: Env, expr: Expr) -> Expr:
    match expr:
        ...
        case Pi(x, domain, codomain):
            ...
            if type_check({**env, x: domain}, codomain) != Star():
        ...
        case App(func, arg):
            ...
            return subst(func_type.var, arg, func_type.codomain)
        case Nat():
            return Star()
        case Zero():
            return Nat()
        ...
        case ElimNat(motive, zero_case, succ_case, target):
            ...
            zero_case_type = type_check(env, zero_case)
            if zero_case_type != App(motive, Zero()):
            ...
            succ_case_type = type_check(env, succ_case)
            if succ_case_type != expected_succ_case_type:
